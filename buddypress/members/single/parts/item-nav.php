	...
	<?php if ( bp_nouveau_has_nav( array( 'type' => 'primary' ) ) ) : ?>
		...
		<ul id="user-profile-menu" class="nav nav-tabs">
			...
			while ( bp_nouveau_nav_items() ) :
				bp_nouveau_nav_item();
			?>
				<li id="<?php bp_nouveau_nav_id(); ?>" class="nav-item">
					<a class="nav-link <?php bp_nouveau_nav_classes(); ?>" href="<?php bp_nouveau_nav_link(); ?>" id="<?php bp_nouveau_nav_link_id(); ?>">
						<?php bp_nouveau_nav_link_text(); ?>

						<?php if ( bp_nouveau_nav_has_count() ) : ?>
							<span class="badge badge-secondary count"><?php bp_nouveau_nav_count(); ?></span>
						<?php endif; ?>
					</a>
				</li>
